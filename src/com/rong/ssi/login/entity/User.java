package com.rong.ssi.login.entity;
...
public class User {
  ...
  private String userPasswordOriginal;
  
public String getUserPasswordOriginal() {
	return userPasswordOriginal;
}
public void setUserPasswordOriginal(String userPasswordOriginal) {
	this.userPasswordOriginal = userPasswordOriginal;
}
